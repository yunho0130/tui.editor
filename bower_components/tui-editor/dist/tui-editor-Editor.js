...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		root["tui"] = root["tui"] || {}, root["tui"]["Editor"] = factory(root["$"], root["tui"]["util"], root["CodeMirror"], root["markdownit"], root["toMark"], root["hljs"], root["Squire"]);
...
var CodeBlockGadget = function (_BlockOverlay) {
  ...
  _createClass(CodeBlockGadget, [{
    ...
    value: function _initDOM() {
      ...
      this._$buttonOpenModalEditor = (0, _jquery2.default)('<button>Editor</button>');
